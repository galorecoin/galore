...
int nAnonymizeGaloreAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Galore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Galore
    // Mac: ~/Library/Application Support/Galore
    // Unix: ~/.Galore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Galore";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Galore.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "galored.pid"));
